...
# TARGET = Target bigip where you need to install as3 rpm
# CREDS = bigip credentials
# TARGET_RPM = Name and path of the image, you can download from https://github.com/F5Networks/f5-appsvcs-extension
