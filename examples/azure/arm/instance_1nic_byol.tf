...

{
    ...
    "variables": {
        ...
        "networkMtuArray": {
            "12.1.2200": "[concat('tmsh modify net vlan internal mtu 1400; RUN_NETWORK=0; EXT_ROUTE=\"\"')]", 
        ...
        "allowUsageAnalytics": {
            ...
            "Yes": {
                ...
                "metricsCmd": "[concat(' --metrics customerId:$${custId},deploymentId:$${deployId},templateName:standalone_1nic-new_stack-supported,templateVersion:4.4.0.1,region:', variables('location'), ',bigIpVersion:', parameters('bigIpVersion') ,',licenseType:BYOL,cloudLibsVersion:', variables('f5CloudLibsTag'), ',cloudName:azure')]"
            }
        }, 
